#include <iostream>
#include "lib/dlib/dlib/dnn.h" /* shape_predictor */
#include "lib/dlib/dlib/data_io.h" /* load_image */
#include "lib/dlib/dlib/opencv.h" /* cv_image */
#include "lib/dlib/dlib/gui_widgets.h" /* image_window, ... */
#include "lib/dlib/dlib/image_processing/frontal_face_detector.h"
...
int main()
{
    try {
        ...
        */
        ...
        deserialize("bin/shape_predictor_68_face_landmarks.dat") >> sp2;
        /*
        ...
        */
        ...
        float value_of_gamma = 1.0;
	      dlib::image_window win_with_frame;
